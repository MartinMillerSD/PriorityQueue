...
class TestPriorityQueue(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.queue.add_to_list("Diego",123456789, "email@sdsu.edu","123 Fake St",1.0,40.0)
        self.queue.add_to_list("Eric",123456789, "email@sdsu.edu","123 Fake St",1.2,50.0)
        self.queue.add_to_list("Indie",123456789, "email@sdsu.edu","123 Fake St",3.2,80.0)
        self.queue.add_to_list("Hank",123456789, "email@sdsu.edu","123 Fake St",3.0,70.0)
        self.queue.add_to_list("Aaron",123456789, "email@sdsu.edu","123 Fake St",0.8,00.0)
        self.queue.add_to_list("Gary",123456789, "email@sdsu.edu","123 Fake St",3.8,50.0)
        self.queue.add_to_list("Charlie",123456789, "email@sdsu.edu","123 Fake St",1.6,30.0)
        self.queue.add_to_list("Charlie",123456789, "email@sdsu.edu","123 Fake St",1.6,30.0)
        self.queue.add_to_list("Charlie",123456789, "email@sdsu.edu","123 Fake St",1.6,30.0)
        self.queue.add_to_list("Brittany",123456789, "email@sdsu.edu","123 Fake St",1.8,20.0)
        self.queue.add_to_list("Geoff",123456789, "email@sdsu.edu","123 Fake St",3.1,60.0)
        self.queue.add_to_list("Issac",123456789, "email@sdsu.edu","123 Fake St",3.1,150.0)
        self.queue.add_to_list("Frank",123456789, "email@sdsu.edu","123 Fake St",3.6,50.0)
        self.queue.add_to_list("Alex",123456789, "email@sdsu.edu","123 Fake St",1.7,10.0)
        self.queue.add_to_list("Ivan",123456789, "email@sdsu.edu","123 Fake St",2.9,80.0)
        self.queue.add_to_list("Derek",123456789, "email@sdsu.edu","123 Fake St",1.2,40.0)
        self.queue.add_to_list("Doug",123456789, "email@sdsu.edu","123 Fake St",1.0,40.0)
        self.queue.add_to_list("Jeff",123456789, "email@sdsu.edu","123 Fake St",3.9,150.0)
    ...
    def test_add_to_list(self):
        ...
        with self.assertRaises(ValueError):
            self.queue.add_to_list("Jack",123456789, "email@sdsu.edu","123 Fake St",40.0,40.0)

        with self.assertRaises(ValueError):
            self.queue.add_to_list("Jack",123456789, "email@sdsu.edu","123 Fake St",-1.0,40.0)

        with self.assertRaises(ValueError):
            self.queue.add_to_list("Jack",123456789, "email@sdsu.edu","123 Fake St",4.0,500)

        with self.assertRaises(ValueError):
            self.queue.add_to_list("Jack",123456789, "email@sdsu.edu","123 Fake St",4.0,-12.9)
    ...
    def test_highest_priority(self):
        ...
        self.queue.add_to_list("Zack",123456789, "email@sdsu.edu","123 Fake St",4.0,150.0)
        self.assertEqual(self.queue.highest_priority().name,"Zack")
        self.assertEqual(self.queue.queue[-1].name,"Zack")
